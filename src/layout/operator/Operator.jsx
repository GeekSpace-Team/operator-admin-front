...
import "../../style/operator/operator.css";
...
const Operator = () => {
  ...
  const getOperator = async () => {
    ...
    await AxiosInstance.get("/admin/get-users-by-role-name?role=" + t)
      .then((resp) => {
        if (!resp.data.err) {
        ...
        <Grid item lg={6} md={6}>
          ...
          >
            <Stack direction={"row"} spacing={3} alignItems={"center"}>
              ...
              <AddOperator getOperator={getOperator} type={type} />
            </Stack>
          </Stack>
        </Grid>
      </Grid>
          ...
          >
            <Table sx={{ minWidth: 650 }} aria-label="simple table">
              ...
              <TableBody>
                {slist.map((item, i) => {
                  return (
                    <TableRow key={`get_operator_key${i}`}>
                      <TableCell
                        style={{
                          color: "#fefefe",
                          fontFamily: "nuntio",
