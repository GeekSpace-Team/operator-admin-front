...
const DeleteUserRoler = (props) => {
  ...
  const deleteUserRole = async () => {
    await AxiosInstance.delete(`/admin/delete-user-role?id=${props.item.id}`)
      .then((response) => {
      ...
      >
        <Box sx={style}>
          <Typography className={classes.text}>
            Siz <em>{props.item.name} </em> atly ulanyjy görnüşiňizi
            hakykatdanam
...
export default DeleteUserRoler;
