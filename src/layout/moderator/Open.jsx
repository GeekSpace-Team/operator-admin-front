...
const Open = (props) => {
  ...
  const [user_number, setUser_number] = useState(props.item.user_number);
  ...
  const handleOpen = () => {
    ...
    setUser_number(props.item.user_number);
  };

  const updateModerator = async (unique_id) => {
    const data = {
      fullname: fullname,
      username: username,
      password: password,
    ...
    await AxiosInstance.put("/admin/update-user", data)
      .then((resp) => {
        if (!resp.data.err) {
          ...
          <Box component="form" sx={{ color: "#fff" }}>
              ...
              <Stack width={"100%"}>
                <FormControl variant="standard">
                  ...
                  <Select
                    ...
                    label="Status"
                  >
                    <MenuItem value={"1"}>Işjeň</MenuItem>
                    <MenuItem value={"2"}>Işjeň däl</MenuItem>
                  </Select>
                </FormControl>
              </Stack>
            </Stack>
            ...
            >
              ...
              <Button
                ...
                onClick={() => updateModerator(props.item.unique_id)}
                variant="contained"
              >
                Yatda saklamak
              </Button>
