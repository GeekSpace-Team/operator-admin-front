...
const AddModerator = (props) => {
  ...
  const [user_role, setUser_role] = useState(4);
  ...
  const addModerator = async () => {
    ...
    await AxiosInstance.post("/admin/add-user", data)
      .then((resp) => {
        handleClose();
